...
final class AsymmetricTest: XCTestCase {
    ...
    func testExample() throws {
        var r = RSA()
        r.setPublicSecKey(keyString: "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAPA5R50q+UJxfB5YZteo7Th6lXBq4ydZ9y7oBoJMhfaltt6KPH4JtIQ3gFLfX2jdSK7mrIa6yTFPA55e7eZzwmECAwEAAQ==")
        print( r.encrypt(sourceString: "LtGKzT3h3LuaSEOq"))
        
//        ik3+V8z2E0EgGYSMl0MtHsS5wQ19CWRL0TtIXdB9Pjlr48Ru7M7172c+c/Jw//j8lksUH+L9NuKWO8dWZRtexQ==
